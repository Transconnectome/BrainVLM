...
def calculate_proportion(num_total_samples:int=None, num_samples_per_dataset:list=None):
    proportion = [ns/num_total_samples for ns in num_samples_per_dataset]
    if sum(proportion) < 1: 
        proportion[-1] = 1 - sum(proportion)
