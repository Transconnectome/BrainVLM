...
class UMBRELLABatch:
    ...
    modality_type: Optional[str] = None  # Legacy: single modality for whole batch
    modality_types: Optional[List[str]] = None  # Per-sample modality: ['T1', 'FA', 'T1_FA', ...]
...
class UMBRELLACollator:
    ...
    def __call__(self, batch: List[Dict[str, Any]]) -> UMBRELLABatch:
        ...
        metadata_list = []
        sample_indices = []
        modality_types = []  # Per-sample modality types for mixed training
        ...
        for item in batch:
            ...
            modality_types.append(item.get('modality_type', 'T1'))  # Per-sample modality
        ...
        return UMBRELLABatch(
            ...
            modality_type=modality_types[0] if modality_types else 'T1',  # Legacy: first sample's modality
            modality_types=modality_types  # Per-sample modality list
        )