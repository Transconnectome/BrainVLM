...
def train_experiment(partition, num_classes, save_dir, args): #in_channels,out_dim
    ...
    if args.model.find('evavit_') != -1:
        net = EvaViT.__dict__[args.model](img_size = args.img_size[0], num_classes=num_classes, use_lora=args.use_lora, use_projector=True, use_pretrained_weight=args.use_pretrained_weight)
    ...
    if args.use_lora:
        lora.mark_only_lora_as_trainable(net, bias='all')
