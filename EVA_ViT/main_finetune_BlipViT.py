...
from envs.finetuning_experiments_BlipViT import *
from envs.inference_experiments import inference_engine
...
#                                                                      'evavit_giant_patch16_3D', 
                                                                      #'evavit2_giant_patch16_3D',
#                                                                     ])
...
if __name__ == "__main__":
    ...
    setting, result = train_experiment(partition, num_classes, save_dir, deepcopy(args))
